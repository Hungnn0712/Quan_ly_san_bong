...
import com.example.myapplication.UI.nguoithue.ThongBaoFragment;
...
public class CaNhanOfChuSanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        notifics = v.findViewById(R.id.notifi_chusan);
        notifics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fragment = new GuiThongBaoFragment();
